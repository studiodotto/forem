...
const ImageIcon = () => (
  ...
  >
    <title id="a17qec5pfhrwzk9w4kg0tp62v27qqu9t">Upload audio</title>
...
function audioUploaderReducer(state, action) {
  ...
  switch (type) {
    ...
    case 'show_copied_audio_message':
      return {
        ...state,
...
export const audioUploader = () => {
  const [state, dispatch] = useReducer(audioUploaderReducer, {
    insertionImageUrls: [],
    uploadError: false,
